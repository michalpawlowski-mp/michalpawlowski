...
const ButtonLink = ({ content, link, external = false }: ButtonLinkProps) => {
  const classes =
    "flex items-center rounded-lg bg-indigo-900 hover:bg-indigo-800 p-2 px-4 font-medium shadow-lg transition-all duration-200 hover:translate-x-0.5 text-white";
